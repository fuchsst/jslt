    ...
    return when (this) {
        is IntNode -> {
            when (other) {
                ...
                is DecimalNode -> DecimalNode(this.value + other.value)
        ...
        is BigDecimalNode -> {
            when (other) {
                ...
                is DecimalNode -> BigDecimalNode(this.value + other.value.toBigDecimal())
        ...
        is BigIntNode -> {
            when (other) {
                ...
                is DecimalNode -> BigDecimalNode(this.value.toBigDecimal() + other.value.toBigDecimal())
                is LongNode -> BigIntNode(this.value + other.value.toBigInteger())
            }
        }
        is DecimalNode -> {
            when (other) {
                is IntNode -> DecimalNode(this.value + other.value)
                is BigDecimalNode -> BigDecimalNode(this.value.toBigDecimal() + other.value)
                is BigIntNode -> BigDecimalNode(this.value.toBigDecimal() + other.value.toBigDecimal())
                is DecimalNode -> DecimalNode(this.value + other.value)
                is LongNode -> DecimalNode(this.value + other.value)
            }
        }
        is LongNode -> {
            when (other) {
